  ...
  template: `
    ...
    <svg:defs>
      ...
      >
        ...
        <svg:feGaussianBlur stdDeviation="4.16667"></svg:feGaussianBlur>
        <svg:feColorMatrix
      ...
      >
        <svg:stop stop-color="#fff"></svg:stop>
        <svg:stop offset="1" stop-color="#fff" stop-opacity="0"></svg:stop>
      </svg:linearGradient>
    </svg:defs>
  `,
  host: {

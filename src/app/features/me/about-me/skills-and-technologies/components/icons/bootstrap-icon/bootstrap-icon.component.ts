...
@Component({
  ...
  template: `
    <svg:defs>
      ...
      >
        <svg:stop offset="0" stop-color="#9013fe"></svg:stop>
        <svg:stop offset="1" stop-color="#6610f2"></svg:stop>
      </svg:linearGradient>
      <svg:linearGradient
        id="b"
        x1="193.51"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <svg:stop offset="0" stop-color="#fff"></svg:stop>
        <svg:stop offset="1" stop-color="#f1e5fc"></svg:stop>
      </svg:linearGradient>
      <svg:filter
        id="c"
        width="197"
      ...
      >
        ...
        ></svg:feColorMatrix>
        <svg:feOffset dy="4"></svg:feOffset>
        <svg:feGaussianBlur stdDeviation="8"></svg:feGaussianBlur>
        <svg:feColorMatrix
